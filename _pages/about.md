...
- *2018.11 - Current*, [HorseCoder Agentic(倚码智能柔性软件)](https://www.horsecoder.com/), Wuhan, China. Founder & CEO. HorseCoder is an AI-driven enterprise software productivity engine built upon the **RGPS (Role-Goal-Process-Service)** requirement meta-model framework — an ISO/IEC international standard. The platform leverages large language models to generate full-stack, deployable enterprise systems from high-level business requirements, covering UI, logic, data modeling, and workflow orchestration. HorseCoder has served **500+ enterprise clients** worldwide, including **Fortune Global 500** enterprises and industry leaders (e.g., **Louis Dreyfus Company**, **Allianz**, **Xiaomi**, **Alibaba**, **JD.com**, **Nanfu**), government agencies, universities, and research institutions, across domains such as smart logistics, agile governance, engineering infrastructure, and digital transformation.